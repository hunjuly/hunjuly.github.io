...
자동차의 경우 바퀴도 바꾸고 엔진도 개조하지만 적어도 뼈대를 변경할 생각은 안 한다.\
왜 소프트웨어는 뼈대에 해당하는 부분까지도 자주 변경하게 될까?\
소프트웨어 만큼 자주 변하는 것으로는 음악이 있다. 유명한 곡이 얼마나 많이 변형되어 불려지는가를 생각해 보면 납득이 된다.


### 소프트웨어의 유연성

> 그래디 부치의 저서에서 이에 대한 그의 통찰을 읽을 수 있다. 아래는 거기에 나의 의견을 추가하는 것이다.
...
음악도 마찬가지인데 누군가 작곡을 의뢰할 때 원하는 것을 어떻게 표현할 수 있을까?
