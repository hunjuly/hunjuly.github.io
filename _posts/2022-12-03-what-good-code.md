...
> 변해야 하는 이유는 다양한데 개발 도중에 요구사항이 계속 바뀌거나 출시를 한 후에도 운영 환경이 변하는 등의 이유가 있다.
> 운영 환경의 변화는 OS의 업그레이드가 될 수도 있고, x86에서 arm으로 CPU가 바뀔 수도 있다.
> 물론 그 외에도 다양한데 인증 서비스가 중단되거나 비용이 높아져서 다른 서비스로 교체하는 등의 일도 자주 일어난다.
